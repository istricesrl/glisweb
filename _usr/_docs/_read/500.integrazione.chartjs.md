...
scatter                     | grafico di distribuzione
...
[...] il blocco data contiene l'indicazione delle labels da utilizzare e i dataset da rappresentare:
```php
$ct['page']['contents']['chartjs'] = array(
    'graficoEsempio' => array(
        'type' => 'bar',
        'data' => array(
            'labels' => array( 'gennaio', 'febbraio', 'marzo' ),
            'datasets' => array(
                'entrate' => array(
                    'data' => array(
                        'febbraio' => array( 'value' => 50 )
                    ),
                    'options' => array(
                ...
                'crediti' => array(
                    'data' => array(
                        'febbraio' => array( 'value' => 30 ),
                        'marzo' => array( 'value' => 50 )
                    ),
                    'options' => array(
                ...
                'uscite' => array(
                    'data' => array(
                        'febbraio' => array( 'value' => 40 )
                    ),
                    'options' => array(
                        'bgColor' => 'rgb( 164, 164, 164 )', 'bdColor' => 'rgb( 64, 64, 64 )'
                    )
                )
            )
        ),
...
```
[...] il colore dei dati può essere specificato per dataset oppure per singolo valore:
```php
$ct['page']['contents']['chartjs'] = array(
    'graficoEsempio' => array(
        'type' => 'bar',
        'data' => array(
            ...
            'datasets' => array(
                'entrate' => array(
                    'data' => array(
                        'febbraio' => array( 'value' => 50, 'bgColor' => 'rgb( 128, 128, 128 )', 'bdColor' => 'rgb( 64, 64, 64 )' )
                    ),
                    'options' => array()
                ),
                'uscite' => array(
                    'data' => array(
                        'febbraio' => array( 'value' => 30, 'bgColor' => 'rgb( 72, 72, 72 )', 'bdColor' => 'rgb( 64, 64, 64 )' )
                    ),
                    'options' => array()
                )
            )
