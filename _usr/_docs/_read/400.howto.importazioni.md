# come fare a creare importazioni dati
...
ha un inizio e una fine chiaramente predeterminate, come meglio spiegato nella pagina sui meccanismi di esecuzione pianificata del framework.
...
Tipicamente, dovendo caricare un file, il metro tool più indicato per avviare l'importazione è il modal (vedi la guida al template athena) che
...
creazione del job di importazione
---------------------------------
Per quanto riguarda il codice del job, rimandiamo alla sezione relativa ai job della documentazione, ci limitiamo qui a dare alcune indicazioni
...
<?php
    ...
    /* FINE CODICE TASK */
```
TODO verificare che questo esempio sia allineato ai job più recenti
