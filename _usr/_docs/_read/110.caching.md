# strategie di caching del framework
...
Twig
----
Twig ha un suo sistema di caching [...]

[...] per favorire le operazioni di sviluppo e di test, è opportuno che la cache di Twig sia disabilitata a questi stage; una buona configurazione può essere:
```json
"twig": {
  "profiles": {
    "DEV": {
