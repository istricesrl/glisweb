...
ALTER TABLE `carrelli`
	...
	ADD KEY `destinatario_nome` (`destinatario_nome`),
	ADD KEY `destinatario_cognome` (`destinatario_cognome`),
	ADD KEY `destinatario_denominazione` (`destinatario_denominazione`),
	...
	ADD KEY `destinatario_indirizzo` (`destinatario_indirizzo`),
	...
	ADD KEY `destinatario_mese_nascita` (`destinatario_mese_nascita`),
	ADD KEY `destinatario_anno_nascita` (`destinatario_anno_nascita`),
	...
	ADD KEY `destinatario_telefono` (`destinatario_telefono`),
	ADD KEY `destinatario_mobile` (`destinatario_mobile`),
	ADD KEY `destinatario_fax` (`destinatario_fax`),
	ADD KEY `destinatario_mail` (`destinatario_mail`),
	ADD KEY `destinatario_codice_fiscale` (`destinatario_codice_fiscale`),
	ADD KEY `destinatario_partita_iva` (`destinatario_partita_iva`),
	ADD KEY `intestazione_nome` (`intestazione_nome`),
	ADD KEY `intestazione_cognome` (`intestazione_cognome`),
	ADD KEY `intestazione_denominazione` (`intestazione_denominazione`),
	...
	ADD KEY `intestazione_indirizzo` (`intestazione_indirizzo`),
	ADD KEY `intestazione_cap` (`intestazione_cap`),
	ADD KEY `intestazione_citta` (`intestazione_citta`),
	...
	ADD KEY `intestazione_giorno_nascita` (`intestazione_giorno_nascita`),
	ADD KEY `intestazione_mese_nascita` (`intestazione_mese_nascita`),
	ADD KEY `intestazione_anno_nascita` (`intestazione_anno_nascita`),
	...
	ADD KEY `intestazione_telefono` (`intestazione_telefono`),
	ADD KEY `intestazione_mobile` (`intestazione_mobile`),
	ADD KEY `intestazione_fax` (`intestazione_fax`),
	ADD KEY `intestazione_mail` (`intestazione_mail`),
	ADD KEY `intestazione_codice_fiscale` (`intestazione_codice_fiscale`),
	ADD KEY `intestazione_partita_iva` (`intestazione_partita_iva`),
	ADD KEY `intestazione_sdi` (`intestazione_sdi`),
	ADD KEY `intestazione_pec` (`intestazione_pec`),
	ADD KEY `nome` (`nome`),
