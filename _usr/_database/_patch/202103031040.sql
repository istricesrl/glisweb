CREATE OR REPLACE VIEW `attivita_view` AS
	...
	attivita.ora_fine,
	coalesce( 
		attivita.data_pianificazione, 
		todo.data_pianificazione 
	) as data_pianificazione,
	coalesce( 
		attivita.ora_inizio_pianificazione, 
		todo.ora_inizio_pianificazione 
	) as ora_inizio_pianificazione,
	coalesce( 
		attivita.ora_fine_pianificazione, 
		todo.ora_fine_pianificazione 
	) as ora_fine_pianificazione,
	attivita.id_pratica,
	...
	day( coalesce( data, data_attivita) ) as giorno,
	month( coalesce( data, data_attivita) ) as mese,
	year( coalesce( data, data_attivita )) as anno,
