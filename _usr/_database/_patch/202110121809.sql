CREATE OR REPLACE VIEW `attivita_view` AS
	...
	attivita.note_programmazione,
	todo.id_pianificazione,
	attivita.id_progetto,
	progetti.nome AS progetto,
	attivita.referente as referenti,
	...
	attivita.note_interne AS note_interne,
	max( categorie_attivita.se_ordinario ) AS se_ordinario,
	max( categorie_attivita.se_straordinario ) AS se_straordinario,
	coalesce(
	...
	LEFT JOIN todo_categorie ON todo_categorie.id_todo = attivita.id_todo
