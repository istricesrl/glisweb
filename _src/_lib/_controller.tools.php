...
*/
			...
			// unisco la tabella di ACL se presente
				...
				$q .= " LEFT JOIN account_gruppi ON ( account_gruppi.id_gruppo = ${aclTb}.id_gruppo OR gruppi_path_check( ${aclTb}.id_gruppo, account_gruppi.id_gruppo ) OR __acl_attivita__.id_account = ? )";
