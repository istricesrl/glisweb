<?php
	...
	$p['pianificazioni.view'] = array(
		...
		'parent'		=> array( 'id'		=> 'archivio' ),
		'template'		=> array( 'path'	=> '_src/_templates/_athena/', 'schema' => 'default.view.html' ),
		'macro'		=> array( '_src/_inc/_macro/_pianificazioni.view.php' ),
	...
	$p['pianificazioni.form'] = array(
		...
		'macro'		=> array( '_src/_inc/_macro/_pianificazioni.form.php' ),
		'auth'		=> array( 'groups'	=> array(	'roots', 'staff'  ) ),
	...
	$p['pianificazioni.form.modello'] = array(
		...
		'macro'		=> array( '_src/_inc/_macro/_pianificazioni.form.modello.php' ),
		'auth'		=> array( 'groups'	=> array(	'roots', 'staff'  ) ),
		'etc'		=> array( 'tabs'	=> $p['pianificazioni.form']['etc']['tabs'] )
	);
	
	// gestione pianificazioni strumenti
	$p['pianificazioni.form.tools'] = array(
	    'sitemap'		=> false,
		'icon'		=> '<i class="fa fa-cogs" aria-hidden="true"></i>',
	    'title'		=> array( $l		=> 'azioni pianificazione' ),
	    'h1'		=> array( $l		=> 'azioni pianificazione' ),
	    'parent'		=> array( 'id'		=> 'pianificazioni.view' ),
	    'template'		=> array( 'path'	=> '_src/_templates/_athena/', 'schema' => 'default.tools.html' ),
	    'macro'		=> array( '_src/_inc/_macro/_pianificazioni.form.tools.php' ),
	    'auth'		=> array( 'groups'	=> array(	'roots', 'staff' ) ),
	    'etc'		=> array( 'tabs'	=> $p['pianificazioni.form']['etc']['tabs'] )
	);