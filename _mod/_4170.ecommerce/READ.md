# modulo e-commerce del framework
...
> non come una descrizione garantita.
  ...
  Il processo standard si può quindi sintetizzare in uno schema:
                                                                   ...
                                                                   |
  +---------------------+    +---------------------+    +----------------------+    +------------------------+    +------------------+
  |   pagina prodotto   | -> |   pagina carrello   | -> |   pagina riepilogo   | -> |   provider pagamento   | -> |   pagina esito   |
  +---------------------+    +---------------------+    +----------------------+    +------------------------+    +------------------+
                                                                                                  |
                                                                                                  |      +-------------------------+
                                                                                                  +----> |   API esito pagamento   |
...
```
  ...
  [...] si noti che per PayPal Advanced Checkout non è possibile saltare la pagina di riepilogo, in quanto è necessario che l'utente inserisca i dati
  della carta di credito se lo desidera.
...
```
  ...
  Il processo per il pagamento con PayPal Advanced Checkout si può quindi sintetizzare in uno schema:
  ...
  pagamento tramite Monetaweb

  note sull'implementazione di nuove forme di pagamento
  -----------------------------------------------------

  [...] aggiungere un elemento all'array delle forme di pagamento in _mod/_4170.ecommerce/_src/_config/_030.common.php

  [...] implementare le logiche necessarie in _mod/_4170.ecommerce/_src/_inc/_macro/_carrello.riepilogo.php

  [...] creare i listener necessari in _mod/_4170.ecommerce/_src/_api/

  [...] se necessario aggiungere un ramo in _mod/_4170.ecommerce/_src/_inc/_macro/_carrello.esito.php
