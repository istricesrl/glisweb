...
ini_set("display_errors", 1);
    ...
    if( isset( $_REQUEST['__carrello__'] ) && is_array( $_REQUEST['__carrello__'] ) ) {
        ...
        if ($spam['check'] === true) {
            ...
            if( isset( $_REQUEST['__carrello__']['intestazione_id_stato'] ) && isset( $_SESSION['carrello']['id_zona'] ) ) {
            ...
            if( ! isset( $_SESSION['carrello']['id'] ) || empty( $_SESSION['carrello']['id'] ) ) {
                ...
                $_SESSION['carrello']['spam_score'] = $spam['score'];
                $_SESSION['carrello']['spam_check'] = $spam['check'];
            ...
            if( isset( $_REQUEST['__carrello__']['__svuota__'] ) && ! empty( $_REQUEST['__carrello__']['__svuota__'] ) ) {
                foreach( $_SESSION['carrello']['articoli'] as $key => $dati ) {
                    $_SESSION['carrello']['articoli'][ $key ]['quantita'] = 0;
                }
            }
            ...
            if( $_SESSION['carrello']['arrotonda_prezzo_finale'] == 1000 ) {

                // arrotondo il prezzo finale
                $_SESSION['carrello']['prezzo_netto_finale'] = round( $_SESSION['carrello']['prezzo_netto_finale'], 5 );
                $_SESSION['carrello']['prezzo_lordo_finale'] = round( $_SESSION['carrello']['prezzo_lordo_finale'], 5 );
                ...
                if( isset( $_SESSION['carrello']['articoli'] ) && is_array( $_SESSION['carrello']['articoli'] ) ) {
                    ...
                    foreach( $_SESSION['carrello']['articoli'] as $dati ) {
                        ...
                        // arrotondo il prezzo finale
                        $_SESSION['carrello']['articoli'][ $rowKey ]['prezzo_netto_totale'] = round( $_SESSION['carrello']['articoli'][ $rowKey ]['prezzo_netto_totale'], 5 );
                        $_SESSION['carrello']['articoli'][ $rowKey ]['prezzo_lordo_totale'] = round( $_SESSION['carrello']['articoli'][ $rowKey ]['prezzo_lordo_totale'], 5 );
                        $_SESSION['carrello']['articoli'][ $rowKey ]['prezzo_netto_finale'] = round( $_SESSION['carrello']['articoli'][ $rowKey ]['prezzo_netto_finale'], 5 );
                        $_SESSION['carrello']['articoli'][ $rowKey ]['prezzo_lordo_finale'] = round( $_SESSION['carrello']['articoli'][ $rowKey ]['prezzo_lordo_finale'], 5 );
