<?php
    ...
    // tabella della vista
    $ct['view']['table'] = 'righe_ricevute_attive';

    $ct['view']['open']['page'] = 'righe.ricevute.amministrazione.form';
...
#		'mastro_destinazione' => 'destinazione',
	...
	$ct['etc']['include']['filters'] = 'inc/righe.ricevute.amministrazione.view.filters.html';
