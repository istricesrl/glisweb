<?php
    ...
    // tabella della vista
    $ct['view']['table'] = 'righe_ricevute_passive';

    $ct['view']['open']['page'] = 'righe.ricevute.passive.amministrazione.form';
...
#		'mastro_destinazione' => 'destinazione',
	...
	$ct['etc']['include']['filters'] = 'inc/righe.ricevute.passive.amministrazione.view.filters.html';
