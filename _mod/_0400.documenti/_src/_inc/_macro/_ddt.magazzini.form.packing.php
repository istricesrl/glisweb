<?php
	...
	$ct['view']['insert']['field'] = 'id_packing_list';

    // campo per il preset di apertura
	$ct['view']['open']['preset']['field'] = 'id_packing_list';
...
//		'id_articolo' => 'codice',
	...
	$ct['view']['class'] = array(
        'nome' => 'text-left',
		'codice_collo' => 'text-left',
        'quantita' => 'text-right',
		'totale_riga' => 'text-right',
        'id_packing_list' => 'd-none',
        'cliente' => 'text-left',
        'emittente' => 'text-left', 
        'data' => 'no-wrap', 
#        'tipologia' => 'text-left',
...
*/
	...
	$ct['etc']['include']['insert'][] = array(
        'name' => 'insert',
        'file' => 'inc/ddt.magazzini.form.packing.insert.html',
        'fa' => 'fa-plus-circle'
    );

	if( isset( $_REQUEST[ $ct['form']['table'] ]['id'] ) ){
		// preset filtro custom progetti aperti
		$ct['view']['__restrict__']['id_packing_list']['EQ'] = $_REQUEST[ $ct['form']['table'] ]['id'];
	}
