<?php
	...
	$ct['view']['open']['page'] = 'righe.offerte.commerciale.form';
    $ct['view']['open']['table'] = 'documenti_articoli';
    $ct['view']['open']['field'] = 'id';

	// pagina per l'inserimento di un nuovo oggetto
	$ct['view']['insert']['page'] = 'righe.offerte.commerciale.form';
...
#        'tipologia' => 'text-left',
	...
	$ct['etc']['include']['insert'][] = array(
        'name' => 'insert',
        'file' => 'inc/offerte.commerciale.form.righe.insert.html',
        'fa' => 'fa-plus-circle'
    );
	...
	require DIR_BASE . '_mod/_0400.documenti/_src/_inc/_macro/_offerte.commerciale.form.default.php';
