<?php
    ...
    if(file_exists(DIR_BASE.'mod/0400.documenti/src/api/print/ricevuta.pdf.php')  ){$file = $ct['site']['url'].'mod/0400.documenti/src/api/print/';}
...
*/
            case 8:
                ...
                $ct['page']['contents']['metro']['pdf'][] = array(
                    'target' => '_blank' ,
                    'url' => $file . 'ricevuta.pdf.php?__documento__='.$_REQUEST[ $ct['form']['table'] ]['id'],
                    'icon' => NULL,
                    'fa' => 'fa-file-pdf-o',
                    'title' => 'stampa PDF',
                    'text' => 'stampa una copia di cortesia della ricevuta in formato PDF'
                );

/*
                $ct['page']['contents']['metro']['download'][] = array(
                    'target' => '_blank' ,
                    'url' => $base . '_ricevuta.pdf.php?__documento__='.$_REQUEST[ $ct['form']['table'] ]['id'].'&d=1',
                    'icon' => NULL,
                    'fa' => 'fa-file-pdf-o',
                    'title' => 'stampa PDF',
                    'text' => 'stampa una copia di cortesia della ricevuta in formato PDF'
                ...
                $ct['page']['contents']['metro']['download'][] = array(
                    'target' => '_blank' ,
                    'url' => $base . '_ricevuta.xml.php?__documento__='.$_REQUEST[ $ct['form']['table'] ]['id'].'&d=1',
                    'icon' => NULL,
                    'fa' => 'fa-file-code-o',
                    'title' => 'stampa XML',
                    'text' => 'stampa la ricevuta in formato XML'
                );
*/
            break;
