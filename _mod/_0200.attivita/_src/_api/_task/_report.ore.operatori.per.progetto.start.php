<?php
    ...
    if( isset( $_REQUEST['mese'] ) && isset( $_REQUEST['anno'] ) ){
        ...
        $status['inserimento'] = mysqlQuery(
            ...
            array(
                array( 's' => 'esportazione ore operatori per progetto ' . $nomemese . ' ' . $_REQUEST['anno'] ),
                array( 's' => '_mod/_0200.attivita/_src/_api/_job/_report.ore.operatori.per.progetto.php' ),
                array( 's' => 10 ),
                array( 's' => json_encode(
                    array(
                        'mese' => $_REQUEST['mese'],
