<?php
	...
	if( in_array( "0400.documenti", $cf['mods']['active']['array'] ) ) {
	    ...
	    if( in_array( "6000.amministrazione", $cf['mods']['active']['array'] ) ) {
            ...
            $p['note.credito.amministrazione.form.attivita'] = array(
                'sitemap'		=> false,
                'icon'			=> '<i class="fa fa-pencil-square-o" aria-hidden="true"></i>',
                'title'			=> array( $l		=> 'attività' ),
                'h1'			=> array( $l		=> 'attività' ),
                'parent'		=> array( 'id'		=> 'note.credito.amministrazione.view' ),
                'template'		=> array( 'path'	=> '_src/_templates/_athena/', 'schema' => 'note.credito.amministrazione.form.attivita.html' ),
                'macro'			=> array( $m.'_src/_inc/_macro/_note.credito.amministrazione.form.attivita.php' ),
                'auth'			=> array( 'groups'	=> array(	'roots', 'staff' ) ),
                'etc'			=> array( 'tabs'	=> 'note.credito.amministrazione.form' )
            );
