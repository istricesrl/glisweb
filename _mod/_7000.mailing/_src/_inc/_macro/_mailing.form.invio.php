<?php
    ...
    // tabella della vista
	$ct['view']['table'] = 'mailing_mail';

    // id della vista
   	# $ct['view']['id'] = md5( $ct['view']['table'] );

    // pagina per la gestione degli oggetti esistenti
	$ct['view']['open']['page'] = 'mailing.mail.form';
    $ct['view']['open']['table'] = 'mailing_mail';
    $ct['view']['open']['field'] = 'id';

	// pagina per l'inserimento di un nuovo oggetto
	$ct['view']['insert']['page'] = 'mailing.mail.form';

    // campo per il preset di apertura
	$ct['view']['open']['preset']['field'] = 'id_mailing';
...
#		'id_documento' => 'id_documento'
	...
	if( isset( $_REQUEST[ $ct['form']['table'] ]['id'] ) ){
		$ct['view']['__restrict__']['id_mailing']['EQ'] = $_REQUEST[ $ct['form']['table'] ]['id'];
	}
