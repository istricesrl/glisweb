<?php
    ...
    // gestione pagine form immagini
    $p['contenuti.archivio.file.form.immagini'] = array(
        'sitemap'            => false,
        'icon'                => '<i class="fa fa-image" aria-hidden="true"></i>',
        'title'                => array( $l        => 'immagini' ),
        'h1'                => array( $l        => 'immagini' ),
        'parent'            => array( 'id'        => 'contenuti.archivio.file.view' ),
        'template'            => array( 'path'    => '_src/_tpl/_athena/', 'schema' => 'contenuti.archivio.file.form.immagini.twig' ),
        'macro'                => array( $m . '_src/_inc/_macro/_contenuti.archivio.file.form.immagini.php' ),
        'auth'                => array( 'groups'    => array(    'roots', 'staff' ) ),
