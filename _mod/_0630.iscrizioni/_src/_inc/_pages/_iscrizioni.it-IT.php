<?php
	...
	$p['iscrizioni.view']	= array(
	    ...
	    'macro'				=> array( '_src/_inc/_macro/_iscrizioni.view.php' ),
	    'auth'				=> array( 'groups'	=> array(	'roots', 'staff' ) ),
	...
	$p['iscrizioni.archivio.view'] = array(
	    ...
	    'template'			=> array( 'path'	=> '_src/_templates/_athena/', 'schema' => 'default.view.html' ),
	    'macro'				=> array( '_src/_inc/_macro/_iscrizioni.archivio.view.php' ),
	    'auth'				=> array( 'groups'	=> array(	'roots', 'staff' ) ),
	...
	$p['iscrizioni.stampe'] = array(
	    ...
	    'macro'				=> array( '_src/_inc/_macro/_iscrizioni.stampe.php' ),
	    'auth'				=> array( 'groups'	=> array(	'roots', 'staff' ) ),
	    'etc'				=> array( 'tabs'	=> $p['iscrizioni.view']['etc']['tabs'] )
	);
