<?php
    ...
    if( isset( $_SESSION['assistenza']['id_todo_consegna'] )  ){
        ...
        $_REQUEST['todo'] = mysqlSelectRow($cf['mysql']['connection'], 'SELECT * FROM todo_view_static WHERE id = ?', array( array( 's' =>  $_SESSION['assistenza']['id_todo_consegna'] ) ));
    ...
    if( !isset( $_REQUEST['documenti'] ) && isset( $_SESSION['assistenza']['id_documento_consegna'] ) ){
        ...
        $_REQUEST['todo'] = mysqlSelectRow($cf['mysql']['connection'], 'SELECT * FROM todo_view_static WHERE id = ?', array( array( 's' => $_REQUEST['documenti']['id_todo']) ));
    }
