...
#	}
    ...
    if(file_exists(DIR_MOD.'6500.casse/src/api/print/manuale.barcode.pdf.php')  ){$file = DIR_MOD.'6500.casse/src/api/print/comandi.cassa.pdf.php';}
    else {$file = DIR_MOD.'_6500.casse/_src/_api/_print/_comandi.cassa.pdf.php';  }
