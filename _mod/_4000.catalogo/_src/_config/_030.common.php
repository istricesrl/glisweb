<?php
    ...
    $cf['catalogo']['pages']['elenco']['template']		= '_src/_templates/_default/';
    ...
    $cf['catalogo']['pages']['scheda']['macro']			= array( '_mod/_4000.catalogo/_src/_inc/_macro/_categorie.prodotti.elenco.php' );
