<?php
    ...
    if( in_array( 'PI000.pianificazioni', $cf['mods']['active']['array'] ) ) {
        ...
        // log
        logWrite( 'il modulo PI000.pianificazioni è attivo, il task populate di _0100.pianificazioni lascia il lavoro a lui', 'pianificazioni' );
                ...
                case 'documenti':
                    ...
                    $object = mysqlInsertRow(
                        ...
                        array(
                            ...
                            'id_sede_emittente'         => $current['model_id_sede_emittente'],
                            'id_destinatario'           => $current['model_id_destinatario'],
                            'id_sede_destinatario'      => $current['model_id_sede_destinatario'],
