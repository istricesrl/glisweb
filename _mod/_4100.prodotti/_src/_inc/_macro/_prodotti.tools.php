...
*/
    ...
    // importazione contatti anagrafica
	$ct['page']['contents']['metro']['importazioni'][] = array(
	    'modal' => array( 'id' => 'importa_prodotti', 'include' => 'inc/prodotti.tools.modal.import.html' ),
	    'icon' => NULL,
	    'fa' => 'fa-upload',
	    'title' => 'importazione prodotti/prodotti',
	    'text' => 'importa prodotti e articoli in formato CSV'
	);
