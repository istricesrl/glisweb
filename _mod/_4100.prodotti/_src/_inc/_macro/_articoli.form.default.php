<?php
    ...
    if( ! isset( $_REQUEST['articoli']['id_prodotto'] ) && isset( $_REQUEST['__preset__']['articoli']['id_prodotto'] ) ) { 
        
        $_REQUEST['articoli']['id_prodotto'] = $_REQUEST['__preset__']['articoli']['id_prodotto']; 
