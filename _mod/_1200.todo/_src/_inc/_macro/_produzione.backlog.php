...
#	    'completato' => 'text-left'
	...
	foreach( $ct['view']['data'] as &$row ) {
		if( is_array( $row ) ) {
			$row[ NULL ] = '<a href="#" data-toggle="modal" data-target="#scorciatoia_todo_backlog" onclick="$(\'#todo_id\').val(\''.$row['id'].'\');$(\'#todo_ore_programmazione.oreprogrammazione\').val(\''.round( $row['ore_programmazione'] ).'\');$(\'#scorciatoia_todo_backlog\').modal(\'show\');"><i class="fa fa-arrow-right"></i></a>';
		}
	}
