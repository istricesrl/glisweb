<?php
	...
	if( isset( $_REQUEST['categorie_annunci']['template'] ) ) {

	    // controllo file
		if( file_exists( DIR_BASE . $_REQUEST['categorie_annunci']['template'] . '/etc/template.conf' ) ) {

		    // configurazione del template
			$config = parse_ini_file( DIR_BASE . $_REQUEST['categorie_annunci']['template'] . '/etc/template.conf', true, INI_SCANNER_RAW );
