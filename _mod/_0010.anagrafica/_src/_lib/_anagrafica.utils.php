<?php
    ...
    /**
     * Logo, PEC e sede legale sono andati NEL CORE il 15/09/2026, in
     * `_src/_lib/_mysql.utils.php`.
     *
     * Non erano roba di questo modulo: leggono tabelle del core e le chiamavano
     * `generaContenutiDocumento()`, undici stampe di `_0400.documenti` e il checkout
     * dell'ecommerce, cioe' codice che gira anche dove questo modulo non e' installato - e li'
     * moriva con "Call to undefined function". Qui restano le `*AnagraficaViewStatic*`, che
     * mantengono la vista materializzata e sono davvero di questo modulo.
     */

    /**
     * 
     * 
     * TODO spostare nel modulo anagrafica
     * 
     */
